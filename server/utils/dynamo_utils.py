...
#TODO: Add a function to create an API key and store it in the database





# items = get_account_id_from_api_key('YourCameraAPIKey')
# print(items)
#time_stamp = str(datetime.now().timestamp())
#response = update_api_key_timestamp('user_camera_api_keys', 'YourCameraAPIKey', '101095', time_stamp)
#print(response)