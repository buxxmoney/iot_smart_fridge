...
# Test endpoint to check if the test wrapper is working
# To Test Run -> curl http://127.0.0.1:5000/test
...
# To Test Run -> curl http://127.0.0.1:5000/get_item_photo/101011/%40rFzFTuHZ%3FMD2zfy%3F4dc
# Example Response
# {
#   "display_photo": "https://t4.ftcdn.net/jpg/02/52/93/81/360_F_252938192_JQQL8VoqyQVwVB98oRnZl83epseTVaHe.jpg"
# }
# Returns the photo URL of the item
...
def fridge_photo(account_id: str):
    ...
    if request.method == 'POST':
        if 'image' in request.files:
            ...
            save_path = f'uploads/{account_id}.jpeg' #TODO: could just make this a generic temp file? race condition?
...
# To Test Run -> curl http://127.0.0.1:5000/list_fridge_items/101011

# Example Response, i.e. an array of items in the fridge
# [
#   {
#     "account_id": "101011",
#     "class": "fruit",
#     "display_photo": "https://t4.ftcdn.net/jpg/02/52/93/81/360_F_252938192_JQQL8VoqyQVwVB98oRnZl83epseTVaHe.jpg",
#     "edge_item_id": "bzM9G7B76.2n23d>F)%E",
#     "expiration": "02/27/2024",
#     "humidity": "12",
#     "item_id": "@rFzFTuHZ?MD2zfy?4dc",
#     "real_photo": "https://food-contact-surfaces.com/wp-content/uploads/2019/12/apple_in_refrigerator-1024x700.jpg",
#     "temperature": "43"
#   }
# ]
    
# Endpoint to list all items in the fridge
...
def fridge_web():
    ...
    conditions = get_latest_fridge_conditions_from_dynamoDB('fridge_conditions', '101095')
    #print(conditions)
    temp = str(conditions[0]['temperature'])
    humid = str(conditions[0]['humidity'])
    #print(temp)
    #print(humid)
    url = get_presigned_url('fridgepictures', '101095',expiration=100)
    #print(url)
